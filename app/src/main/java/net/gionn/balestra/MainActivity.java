...
public class MainActivity extends AppCompatActivity {
    ...
    public void calculate(View view) {
        ...
        int vertical = Integer.parseInt(verticalSizeText.getText().toString());
        int horizontal = Integer.parseInt(horizontalSizeText.getText().toString());

        Integer result = vertical * 2;
